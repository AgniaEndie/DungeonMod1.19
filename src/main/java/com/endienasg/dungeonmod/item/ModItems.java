package com.endienasg.dungeonmod.item;

import com.endienasg.dungeonmod.DungeonMod;
import com.endienasg.dungeonmod.block.ModBlocks;
...
public class ModItems {
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, DungeonMod.MODID);
    ...
    private static Item.Properties props() {
        return new Item.Properties().tab(DungeonMod.TAB);
    }
